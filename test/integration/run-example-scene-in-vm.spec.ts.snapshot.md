...
sequenceDiagram
  ...
  activate renderer
    ...
    scene-->>renderer: PUT c=1017 e=0x254 t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x255 t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x256 t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x259 t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x25a t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x25b t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x25e t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x25f t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x260 t=1 #v=byte[14]
    scene-->>renderer: PUT c=1017 e=0x261 t=1 #v=byte[19]
